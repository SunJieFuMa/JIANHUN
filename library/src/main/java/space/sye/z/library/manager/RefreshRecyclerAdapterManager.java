...
public class RefreshRecyclerAdapterManager {
    ...
    protected RefreshRecyclerAdapterManager(
        ...
        if (layoutManager instanceof GridLayoutManager){
            ...
            ((GridLayoutManager)layoutManager).setSpanSizeLookup(
                    new HeaderSapnSizeLookUp(mAdapter, (GridLayoutManager) layoutManager));
        }
        this.mLayoutManager = layoutManager;
    }
        ...
        if(mode == RecyclerMode.BOTH) {
            if(!hasMore) {
                ...
                if(loadMoreRecyclerListener != null) {
                    loadMoreRecyclerListener.setMode(RecyclerMode.TOP);
                }
            }
            ...
            if(!hasMore) {
                ...
                if(loadMoreRecyclerListener != null) {
                    loadMoreRecyclerListener.setMode(RecyclerMode.NONE);
                }
            }
            ...
            if(hasMore) {
                ...
                if(loadMoreRecyclerListener != null) {
                    loadMoreRecyclerListener.setMode(RecyclerMode.BOTTOM);
                }
            }
            ...
            if(hasMore) {
                ...
                if(loadMoreRecyclerListener != null) {
                    loadMoreRecyclerListener.setMode(RecyclerMode.BOTH);
                }
            }
        }
    }
