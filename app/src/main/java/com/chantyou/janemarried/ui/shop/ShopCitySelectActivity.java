...
import com.chantyou.janemarried.ui.base.City;
 ...
 * 
 */
public class ShopCitySelectActivity extends PullrefreshBottomloadActivity implements XLocationManager.OnGetLocationListener {
    ...
    public static void launchForResult(Activity act) {
        Intent intent = new Intent(act, ShopCitySelectActivity.class);
    ...
    protected void init() {
        ...
        //其实没有从网络获取，是从本地assets--city.txt中获取的城市信息，存的是json字符串
...
//                                mLoadListView.setSelection(position);
    ...
    public void onGetLocationFinished(AMapLocation location, boolean bSuccess) {
        if(bSuccess) {
            adapter.cCity = location.getCity();
...
//                        }
                                ...
                                showYesOrNoDialog("提示", "确定", "取消", "确定更改所在城市为："+mc+"？", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (which == DialogInterface.BUTTON_POSITIVE) {
                                            ...
                                            pushEventEx(false, null, new UserEditRunner("", "", "", "", mc, "", ""), ShopCitySelectActivity.this);
                                        }
                                    }
                                });
                            } else {
    ...
    protected void onResume() {
        super.onResume();
        StatService.onResume(ShopCitySelectActivity.this);
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPause(ShopCitySelectActivity.this);
    }
}
