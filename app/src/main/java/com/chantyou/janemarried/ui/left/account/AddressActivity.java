 ...
 */
public class AddressActivity extends XBaseActivity {

    public static final int RCODE = 27;
    ...
    protected void onResume() {
        super.onResume();
        StatService.onResume(AddressActivity.this);
    ...
    protected void onPause() {
        super.onPause();
        StatService.onPause(AddressActivity.this);
    }
}
