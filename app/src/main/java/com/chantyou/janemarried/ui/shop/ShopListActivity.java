...
//店铺列表
public class ShopListActivity extends BaseTabsActivity implements SmoothListView.ISmoothListViewListener, EventManager.OnEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 设置筛选数据
        filterView.setFilterData(ShopListActivity.this, filterData);

        // 设置筛选数据
        headerFilterViewView = new HeaderFilterViewView(ShopListActivity.this);
    ...
    private void initData() {
        ...
        mScreenHeight = DensityUtil.getWindowHeight(ShopListActivity.this);
        ...
        //所在城市
        city = SharedPreferenceUtils.getString(ShopListActivity.this, SharedPreferenceKey.userCity, "济南");
        //获取商铺列表
//        getShopList();
        getShopList2();//改成了2
...
//        pushEvent(new ShopListRunner("", city, county, merryType, "", "", page + "", pageSize + ""), this);
    }
    ...
    private void initListener() {
        ...
        headerFilterViewView.setOnFilterClickListener(new HeaderFilterViewView.OnFilterClickListener() {
            ...
            public void onFilterClick(int position) {
                ...
                isSmooth = true;
                smoothListView.smoothScrollToPositionFromTop(filterViewPosition, DensityUtil.dip2px(ShopListActivity.this, titleViewHeight));
            }
        });
...
//                getShopList();
        ...
        smoothListView.setOnScrollListener(new SmoothListView.OnSmoothScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if (itemHeaderAdView != null) {
                    adViewTopSpace = DensityUtil.px2dip(ShopListActivity.this, itemHeaderAdView.getTop());
                    adViewHeight = DensityUtil.px2dip(ShopListActivity.this, itemHeaderAdView.getHeight());
                }
                ...
                if (itemHeaderFilterView != null) {
                    filterViewTopSpace = DensityUtil.px2dip(ShopListActivity.this, itemHeaderFilterView.getTop());
                }
    ...
    private void handleTitleBarColorEvaluate() {
        ...
        if (fraction >= 1f || isStickyTop) {
            ...
            rlBar.setBackgroundColor(ShopListActivity.this.getResources().getColor(R.color.orange));
        } else {
            viewTitleBg.setAlpha(1f - fraction);
            viewActionMoreBg.setAlpha(1f - fraction);
            rlBar.setBackgroundColor(ColorUtil.getNewColorByStartEndColor(ShopListActivity.this, fraction, R.color.transparent, R.color.orange));
        }
    }
...
//                getShopList();
                ...
                if (event.isSuccess()) {
                    ...
                    if (null != shopList) {
                        if (shopList.size() > 0) {
                            if (LoadType.Refresh == loadType || LoadType.Load == loadType) {
                                shopList.clear();
                                shopList.addAll(shopListBean.getData());
                            } else if (LoadType.LoadMore == loadType) {
                                shopList.addAll(shopList.size(), shopListBean.getData());
                            }
                        }
                    }else {
                        shopList = new ArrayList<ShopListBean.DataBean>();
                    ...
                    if (null != shopListBean.getData() && shopListBean.getData().size() < 1) {
                        if (LoadType.LoadMore != loadType) {
                            ...
                            int height = mScreenHeight - DensityUtil.dip2px(ShopListActivity.this, 95); // 95 = 标题栏高度 ＋ FilterView的高度
    ...
    public void onResume() {
        super.onResume();
        StatService.onResume(ShopListActivity.this);
    }

    @Override
    public void onPause() {
        super.onPause();
        StatService.onPause(ShopListActivity.this);
    }
