...
//案例详情
public class ShopPackageInfoFragment extends BottomLoadFragment implements EventManager.OnEventListener {
...
//                    }
    ...
    public void onResume() {
        super.onResume();
        StatService.onResume(ShopPackageInfoFragment.this);
    }

    @Override
    public void onPause() {
        super.onPause();
        StatService.onPause(ShopPackageInfoFragment.this);
    }
}
