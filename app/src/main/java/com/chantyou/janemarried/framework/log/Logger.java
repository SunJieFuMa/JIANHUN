package com.chantyou.janemarried.framework.log;
...
public final class Logger
{
    ...
    public static final String LOG_DIR = Environment
            .getExternalStorageDirectory()
                .getAbsolutePath() + "/" + APKUtil2.getPackageName(AppAndroid.getApp().getApplicationContext()) + "/log/";
     ...
     * log path
     */
    public static final String LOG_FILE_PATH = LOG_DIR + APKUtil2.getPackageName(AppAndroid.getApp().getApplicationContext()) + "_v"
            + APKUtil2.getVerName(AppAndroid.getApp().getApplicationContext()) + LOG_FILE_SUFFIX;
