...
public class Constants {
    ...
    private static final String HTTP_CODE = "return_code";
...
//    public static String TB_SECRET = "1105153797";
    ...
    public static boolean verifySuccess(JSONObject jsonObject) {
        return jsonObject.optInt(HTTP_CODE) == 0;
    }
...
//    public static String[] PRODUCT = {"all", "hunsha", "hunxie", "lifu","peishi","hunfang"};
    ...
    public static String buildCardUrl(int uid, int pageId, int cid) {
        System.out.println("zhuwx" + "http://www.easymarrytec.com/MarryTrade/card.html?uid=" + uid + "&page=" + pageId + "&cId=" + cid);
    ...
    /**
     * 保存 Token 对象到 SharedPreferences。--其实是保存到了数据库里面
     *
